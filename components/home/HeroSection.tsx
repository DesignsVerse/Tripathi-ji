...
export default function HeroSection() {
  return (
    <section className="relative bg-gradient-to-b from-[#FFF8F0] to-[#FFE4C4] overflow-hidden border-b-2 border-[#FF9933]/30 min-h-[90vh] flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-12 lg:py-16">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="w-full flex justify-center order-1 md:order-none h-56 sm:h-72 md:h-[400px] lg:h-[500px] mb-6 md:mb-0">
          ...
          {/* Text Content */}
          <div className="relative z-10 space-y-6 md:space-y-8 order-2 md:order-none text-center md:text-left flex flex-col items-center md:items-start w-full max-w-xl mx-auto">
            {/* Premium badge */}
            <div className="inline-flex items-center px-4 py-2 sm:px-5 sm:py-3 bg-gradient-to-r from-[#FFD700] to-[#FF9933] rounded-full border-2 border-[#FF5722]/50 shadow-lg">
            ...
            <div className="space-y-4 sm:space-y-5">
              ...
              <p className="text-base sm:text-lg md:text-xl text-[#321414]/90 leading-relaxed font-medium">
            ...
            <div className="flex flex-row gap-5 pt-4 w-full sm:w-auto justify-center md:justify-start">
              <Button className="relative overflow-hidden group bg-gradient-to-br from-[#FF5722] to-[#FF9933] hover:from-[#E64A19] hover:to-[#FF5722] text-white px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base font-bold shadow-lg sm:shadow-xl hover:shadow-[#FF5722]/50 transition-all duration-300">
              ...
              <Button variant="outline" className="relative overflow-hidden group border border-[#321414] sm:border-2 text-[#321414] hover:bg-[#FF9933]/10 hover:border-[#FF5722] px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base font-bold shadow-sm sm:shadow-md transition-all duration-300">
                <span className="relative z-10 flex items-center">
